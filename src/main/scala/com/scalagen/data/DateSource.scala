...
case class DateSource(start: LocalDate, incrementUnit: Period = Period.ofWeeks(1))
                     (implicit fmt: DateTimeFormatter = Implicits.fmt) extends Source[Iterator[LocalDate], String] {
